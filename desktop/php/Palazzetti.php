        ...
        <div class="input-group pull-right" style="display:inline-flex">
			<span class="input-group-btn">
				<a class="btn btn-default btn-sm eqLogicAction roundedLeft" data-action="configure"><i
                            class="fas fa-cogs"></i> {{Configuration avancée}}</a><a
        ...
        <div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="eqLogicAttr form-control" data-l1key="name"
                                       placeholder="{{Nom de l'équipement Palazzetti}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="eqLogicAttr form-control" data-l1key="configuration"
                                       data-l2key="addressip" type="text" placeholder="{{Saisir l'adresse IP}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"></label>
                            <div class="col-sm-9">
                                <label class="checkbox-inline"><input id="deamoncheck" type="checkbox"
                                                                      class="eqLogicAttr" data-l1key="configuration"
                                                                      data-l2key="ModeHIGH"/>{{Poêle mode HIGH}}</label>
                            </div>
                        </div>
                    </fieldset>
                </form>
            ...
            <div role="tabpanel" class="tab-pane" id="commandtab">
                ...
                <a class="btn btn-success btn-sm cmdAction pull-right" data-action="add" style="margin-top:5px;"><i
                            class="fas fa-plus-circle"></i> {{Ajouter une Commande}}</a><br/><br/>
            </div>
        </div>
    </div>
</div>
